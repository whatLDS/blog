  ...
  <div class="login">
    ...
    <form class="login-wrap<?php echo isset($message) ? ' shake animated' : ''; ?>" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" autocomplete="off" novalidate>
      ...
      <div class="form-group">
        <?php if (isset($_SESSION['current_login_user'])): ?>
          <label for="email" class="sr-only">邮箱</label>
        <input id="email" name="email" type="email" class="form-control" placeholder="邮箱"  value="<?php echo $_SESSION['current_login_user']['email']; ?>">
        <?php else: ?>
          <label for="email" class="sr-only">邮箱</label>
